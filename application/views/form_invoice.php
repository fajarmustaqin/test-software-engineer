			...
			<div class="row">
				<div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat_pengirim" class="form-control" maxlength="255" rows="2" placeholder="Alamat lengkap" ></textarea>
					</div><br>
					<div class="form-group">
						<label for="">Date</label>
						<div class="input-group">
							<input type="text" class="form-control datepicker" name="tanggal" id="tanggal" value="<?= $tanggal ?>">
				...
				<div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat_penerima" class="form-control" maxlength="255" rows="2" placeholder="Alamat lengkap" ></textarea>
					</div><br>
					<div class="form-group">
						<label for="">Date Due</label>
						<div class="input-group">
							<input type="text" class="form-control datepicker" name="tempo" id="tempo" value="<?= $tanggal ?>">
							<span class="input-group-text"><i class="fa fa-calendar"></i></span>
						</div>
					</div>
				</div>
